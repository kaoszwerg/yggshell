...
export const en = {
  ...
  "chain.undeclared": "This project does not declare its runs",
  "chain.undeclaredHint":
    "Without work-levels.json every level is a guess — including whether a run reaches production.",
