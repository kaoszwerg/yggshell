...
export const en = {
  ...
  "notes.howProjects":
    "No notes for this project yet. Note something while a terminal is in a repository and a project appears for it — keyed off the repository's remote, so it is the same folder on every machine.",
