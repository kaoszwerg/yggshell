...
export const de: Translations = {
  ...
  // Die Wörter, die macOS in seiner eigenen Menüleiste zeigt — daher die Formulierungen des Systems
  // und nicht die dieser App.
  "menu.about": "Über YggShell",
  "menu.settings": "Einstellungen…",
  "menu.services": "Dienste",
  "menu.hide": "YggShell ausblenden",
  "menu.hideOthers": "Andere ausblenden",
  "menu.showAll": "Alle einblenden",
  "menu.quit": "YggShell beenden",
  "menu.shell": "Shell",
  ...
  "menu.fontBigger": "Größere Schrift",
  "menu.fontSmaller": "Kleinere Schrift",
  "menu.fontReset": "Originalgröße",
  "menu.logs": "Protokoll",
  "menu.tools": "Werkzeuge",
  "menu.tool.git": "Repository",
  "menu.tool.files": "Dateien",
  ...
  "chain.undeclared": "Dieses Projekt erklärt seine Läufe nicht",
  "chain.undeclaredHint":
    "Ohne work-levels.json ist jede Stufe geraten — auch die Frage, ob ein Lauf die Produktion erreicht.",
  ...
  "notes.captured": "Notiert",
  "notes.captureFailed": "Notiz konnte nicht abgelegt werden",
  "notes.captureThis": "Hierzu notieren",
  ...
  "notes.howProjects":
    "In diesem Projekt gibt es noch keine Notizen. Notiere oben etwas, dann landet es in der Inbox dieses Projekts — oder lege über das Menü neben dem Namen ein weiteres Projekt an.",
  ...
  "notes.projectMenu": "Projekt: {project}",
  "notes.newProject": "Neues Projekt",
  "notes.renameProject": "Dieses Projekt umbenennen",
  "notes.renameTopic": "Diese Datei umbenennen",
  "notes.editItem": "In der Ansicht bearbeiten",
  ...
  "notes.lens.label": "Wie die Notiz gezeigt wird",
  "notes.lens.read": "Lesen",
  "notes.lens.split": "Geteilt",
  "notes.lens.write": "Schreiben",
  "notes.lens.tooNarrow": "Zu schmal für zwei Spalten",
  "notes.follow": "Beide Seiten auf derselben Stelle halten",
  "notes.splitter": "Editor und Vorschau",
  "notes.editor": "Notiztext",
  "notes.editHint": "Block anklicken schreibt an dieser Stelle · Escape kehrt zurück und speichert",
  "notes.saveFailed": "Die Notiz konnte nicht gespeichert werden",
  "notes.imageFailed": "Das Bild konnte nicht hinzugefügt werden",
  ...
  "notes.import.files": "Markdown-Dateien importieren…",
  "notes.import.folder": "Ordner importieren…",
  "notes.import.result": "Was importiert wurde",
  "notes.import.summary": "{notes} Notizen, {images} Bilder",
  "notes.import.dismiss": "Diesen Bericht schließen",
  "notes.importFailed": "Import nicht möglich",
  "notes.newTopic": "Neues Topic",
  "notes.openFile": "{name} öffnen",
  "notes.syncFailed": "Kein Sync: {reason}",
  "notes.syncNow": "Jetzt synchronisieren",
  "notes.clearSearch": "Suche zurücksetzen",
  "notes.inSync": "Synchron",
  "notes.notPushed": "{count} nicht gepusht",
  "notes.unsaved": "Noch nicht gepusht",
  "notes.localOnly": "Nur lokal — kein Remote",
  "notes.filesInto": "landet in {project}",
  "notes.moveTo": "Verschieben nach {where}",
  "notes.topicName": "Name des Topics",
  "notes.toTerminal": "Ins Terminal tippen",
  "notes.remoteImage": "Entferntes Bild — nicht geladen",
  "notes.openImage": "Dieses Bild öffnen",
  "notes.loadingImage": "Wird geladen…",
  "notes.zoomIn": "Vergrößern",
  "notes.zoomOut": "Verkleinern",
  "notes.zoomFit": "Ins Fenster einpassen",
  "notes.zoomActual": "Originalgröße",
  ...
  "scheme.import": ".itermcolors importieren…",
  "scheme.importing": "Wird importiert…",
