...
export const de: Translations = {
  ...
  // ── Window chrome ────────────────────────────────────────────────────────────────────────────
  "titlebar.attachTo": "An {session} anhängen",
  ...
  "env.noCwd": "Es wird darauf gewartet, dass das Terminal meldet, wo es steht.",
  "env.noDirenv": "direnv ist nicht installiert, eine .envrc wird also nicht geladen.",
  "env.install": "Installieren",
  "env.installed": "Mit {manager} installiert.",
  "env.notAllowed": "Dieses Projekt hat eine .envrc, die direnv nicht laden darf.",
  "env.usedHere": "hier benutzt",
  "env.noHomes": "Keine Claude-Konten im Home-Verzeichnis gefunden.",
  "env.newHome": "Neues Konto",
  "env.newHomePlaceholder": "arbeit",
  "env.create": "Anlegen",
  ...
  "agent.unknownModel": "Unbekanntes Modell",
  "agent.account": "Konto",
  "agent.context": "Kontext",
  "agent.written": "Geschrieben",
  "agent.turns": "Züge",
  "agent.branch": "Branch",
  "agent.lastTurn": "Letzter Zug",
  "agent.disclaimer":
    "Aus den Arbeitsdateien des Harness gelesen. Keine Schnittstelle, deren Bestand zugesagt ist.",
  "statusbar.agent": "{model} · {turns} Züge · {written} geschrieben · {account}",
  "statusbar.item.agent.hint": "Wie viel Kontext der Agent in diesem Tab trägt",
  "statusbar.item.agent": "Agent-Kontext",
  "nav.docker": "Docker",
  "docker.reading": "Der Daemon wird gefragt…",
  "docker.refresh": "Erneut lesen",
  "docker.count": "{count} Container",
  "docker.none": "Keine Container — oder kein Docker auf dieser Maschine.",
  ...
  "activity.refresh": "Erneut lesen",
  "activity.thisTab": "Prozesse dieses Tabs",
  "activity.viaTmux": "Die ganze tmux-Session",
  "activity.ports": "Lauschend",
  "activity.processes": "Prozesse",
  "activity.noPorts": "Nichts lauscht.",
  "activity.noProcesses": "Nichts läuft.",
  "nav.files": "Dateien",
  ...
  "notes.search": "Alle Notizen durchsuchen",
  "notes.none": "Hier ist noch nichts.",
  "notes.actions": "Aktionen für {name}",
  "notes.howProjects":
    "Für dieses Projekt gibt es noch keine Notizen. Notiere etwas, während ein Terminal in einem Repository steht — daraus entsteht das Projekt, benannt nach dessen Remote, also auf jeder Maschine derselbe Ordner.",
  "notes.noneAnywhere": "In keinem Projekt gibt es bisher Notizen.",
  "notes.noProject": "Kein Projekt — Notizen landen im gemeinsamen Eingang.",
  "notes.allProjects": "Alle Projekte",
  "notes.thisProject": "Dieses Projekt",
  "notes.done": "Erledigt · {count}",
  "notes.tick": "Als erledigt markieren",
  "notes.untick": "Als offen markieren",
  "notes.open": "Vollansicht öffnen",
  "notes.openNote": "In der Ansicht öffnen",
  "notes.copy": "Kopieren",
  "notes.copyBlock": "Diesen Block kopieren",
  "notes.delete": "Löschen",
  "notes.deleteNote.title": "Notiz löschen",
  "notes.deleteNote.question": "{topic} löschen?",
  "notes.deleteNote.detail":
    "Sie bleibt in der Historie des Repositories — jede Löschung hier ist ein Commit, es ist also nie wirklich weg.",
  "notes.deleteNote.confirm": "Löschen",
  "notes.deleteProject.title": "Projekt löschen",
  "notes.deleteProject.question": "Alle Notizen in {project} löschen?",
  "notes.deleteProject.detail":
    "{notes} Notizen und ihre Bilder. Sie bleiben in der Historie des Repositories.",
  "notes.cancel": "Abbrechen",
  "notes.read": "Lesen",
  "notes.edit": "Schreiben",
  "notes.editHint": "Block anklicken schreibt an dieser Stelle · Escape zurück",
  "notes.newTopic": "Neues Topic",
  "notes.topicName": "Name des Topics",
  ...
  "settings.notes.sync": "Synchronisieren",
  "settings.notes.connect": "Verbinden",
  "settings.notes.connected": "Verbunden",
  "settings.notes.isConnected": "● Mit diesem Repository verbunden",
  "settings.notes.notConnected": "○ Nicht verbunden",
  "settings.notes.disconnect": "Trennen",
  ...
  "profiles.tmux": "tmux",
  "profiles.tmuxHint":
    "Was eine globale Einstellung nicht sagen kann: diese Art Tab benutzt tmux, jene nicht. Auf Standard folgt der Tab der Einstellung oben.",
